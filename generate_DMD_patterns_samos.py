...
sys.path.append('C:/Users/Kate/Documents/hadamard_code')
...
#KJK folder = 'C:/Users/Kate/Documents/hadamard/mask_sets/' # Change path to fit user needs
folder = 'C:/Users/KevinKearney/code/hadamard_code_111022/mask_sets/'
...
name = 'S'+str(order)+'_'+str(slit_width)+'w_mask_'+str(order)+'.bmp'  #KJK pick up the last file created
print('Plot file: ', name)

im =np.asarray(Image.open(folder+name), dtype='float64')
print('im_size: ', np.shape(im))
